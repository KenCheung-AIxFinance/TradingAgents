...
def save_report_to_disk(final_state: dict, ticker: str, save_path: Path) -> Path:
    """Save a complete analysis report tree to disk.

    Writes per-agent markdown files into numbered sub-directories and a
    consolidated complete_report.md.  Shared by the CLI and backtest runner
    so both produce identical output structures.
    """
